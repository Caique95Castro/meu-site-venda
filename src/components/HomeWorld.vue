<template>
  <div class="container-geral-home">
    ...
    <div class="content-inicio-topo-1">
      <div class="content-inicio-image">
        <img
          class="image-inicio"
          src="../assets/img/image-2-meio.webp"
          alt=""
        />
      </div>
    ...
    <div class="content-inicio-topo-1">
      <div class="content-inicio-text-2">
        <p class="sub-inici">Soluções para</p>
        <h1 class="titulo-inici">
      ...
      <div class="content-inicio-image">
        <img class="image-inicio-1" src="../assets/img/image-1.png" alt="" />
      </div>
    </div>
